class BillingPlanDefinition {
  ...
  static const plans = <BillingPlanDefinition>[
    BillingPlanDefinition(
      ...
      features: <String>[
        '1 Business Location',
        'Business Profile Audit and Health Score',
    ...
    BillingPlanDefinition(
      ...
      features: <String>[
        ...
        'Review QR code and poster generator',
